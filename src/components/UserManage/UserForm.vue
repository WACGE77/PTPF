<template>
  ...
  <div class="form-header">
    <h3 class="form-title">
      {{ userData.id === 0 ? '添加用户' : '编辑用户' }} {{ userData.id === 0 ? '' : userData.name }}
    </h3>
  </div>
  ...
  <el-form ref="formRef" :model="userData" :rules="formRules" label-width="100px" class="user-form">
    ...
    <el-form-item label="昵称" prop="name">
      <el-input v-model="userData.name" placeholder="请输入昵称" max-length="50" />
    </el-form-item>

    <el-form-item label="邮箱" prop="email">
      <el-input v-model="userData.email" type="email" placeholder="请输入邮箱" max-length="100" />
    </el-form-item>

    <el-form-item label="手机号" prop="phoneNumber">
      <el-input v-model="userData.phone_number" placeholder="请输入手机号" max-length="11" />
    </el-form-item>
